...
## Mes deux domaines de spécialisation

### Automatisation & Agentic AI
...
| [**Web Scraping & Réponses Avis**](https://github.com/victoriiavdl/projet_webscraping_api.cv) | Scraping multi-plateformes (Amazon, Trustpilot, Yelp, Google Maps, Play Store) & génération automatisée de réponses aux avis clients via API FastAPI + LLM | ![Automatisation](https://img.shields.io/badge/Automatisation-EA4B71?style=flat-square) ![NLP](https://img.shields.io/badge/NLP-09A3D5?style=flat-square) | Python · Selenium · FastAPI · GPT4All |
...
| [Voir le repo](https://github.com/victoriiavdl/finance.esg) | Analyse ESG & Finance — scoring et visualisation de données ESG | ![ML](https://img.shields.io/badge/ML-F7931E?style=flat-square) ![Analyse](https://img.shields.io/badge/Analyse-6D00CC?style=flat-square) | Python |
...
[![HubSpot](https://img.shields.io/badge/HubSpot-FF7A59?style=flat-square&logo=hubspot&logoColor=white)](https://www.hubspot.com/)
[![Claude](https://img.shields.io/badge/Claude-D97757?style=flat-square)](https://claude.ai/)
...
[![UiPath](https://img.shields.io/badge/UiPath-FA4616?style=flat-square&logo=uipath&logoColor=white)](https://www.uipath.com/)

---

## Soft skills

- **Communication** — vulgarisation de sujets techniques pour des interlocuteurs métier (finance, marketing, direction)
- **Gestion de projet** — coordination d'équipe, priorisation, suivi de livrables dans des environnements agiles
- **Esprit d'analyse** — capacité à structurer des problématiques complexes et à formuler des recommandations actionnables
- **Autonomie & curiosité** — veille continue sur les outils IA, expérimentation de nouveaux workflows et technologies
- **Adaptabilité** — passage fluide entre environnements startup (Bridge) et grands groupes (Savencia)
