...
|---|---|---|---|
| [**Challenge Nexialog × Mobilize**](https://github.com/victoriiavdl/nexialog.cv) | Prédiction de valeur résiduelle automobile — dashboard interactif avec simulateur de stress test et assistant IA | ![ML](https://img.shields.io/badge/ML-F7931E?style=flat-square) ![Data%20Viz](https://img.shields.io/badge/Data%20Viz-FF4B4B?style=flat-square) | Python · Flask · CatBoost · XGBoost · Docker · Ollama |
